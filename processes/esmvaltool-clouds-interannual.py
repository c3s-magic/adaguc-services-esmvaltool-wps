...
class Process(WPSProcess):
    def __init__(self):
        ...
        WPSProcess.__init__(self,
                            identifier="esmvaltool-clouds-interannual",  # the same as the file name
                            version="1.0",
                            title="Cloud cover interannual variability maps",
                            storeSupported="True",
                            statusSupported="True",
                            abstract="Create cloud cover interannual variability maps using ESMValTool (takes about 30 seconds).",
                            grassLocation=False)
	...
	for model in models:
        ...
        template = environment.get_template('namelist_clouds_interannual.xml')
